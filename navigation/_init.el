...
(global-set-key [M-pause] 'kill-this-buffer)
...
(global-set-key [(meta +)] 'other-window)
(global-set-key [C-S-kp-tab] 'previous-multiframe-window)
(global-set-key [(meta _)] 'previous-multiframe-window)
...
(global-set-key [mouse-9] 'tabbar-forward-tab)
(global-set-key [mouse-8] 'tabbar-backward-tab)
(global-set-key [XF86Forward] 'tabbar-forward-tab)
(global-set-key [XF86Back] 'tabbar-backward-tab)
(global-set-key [browser-forward] 'tabbar-forward-tab)
(global-set-key [browser-back] 'tabbar-backward-tab)
;;(global-set-key [mouse-5] 'tabbar-forward-tab)
;;(global-set-key [mouse-4] 'tabbar-backward-tab)

(global-set-key [C-browser-forward] 'tabbar-forward-group)
(global-set-key [C-browser-back] 'tabbar-backward-group)
(global-set-key [C-XF86Forward] 'tabbar-forward-group)
(global-set-key [C-XF86Back] 'tabbar-backward-group)
(global-set-key [C-mouse-5] 'tabbar-forward-group)
(global-set-key [C-mouse-4] 'tabbar-backward-group)
